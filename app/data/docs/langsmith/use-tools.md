...
url: "https://docs.langchain.com/langsmith/use-tools"
section: "langsmith"
last_modified: "2026-01-08T16:42:32.528Z"
---
...
To add a tool to your prompt, click the `+ Tool` button at the bottom of the prompt editor. ![Add tool](https://mintcdn.com/langchain-5e9cc07a/E8FdemkcQxROovD9/langsmith/images/add-tool.png?fit=max&auto=format&n=E8FdemkcQxROovD9&q=85&s=b922d9b219cff1bbc726bc2f6b82d6b6) 
...
![Web search tool](https://mintcdn.com/langchain-5e9cc07a/1RIJxfRpkszanJLL/langsmith/images/web-search-tool.gif?s=2fb882f785abc26d0e5412557cc982ca)
...
![Custom tool](https://mintcdn.com/langchain-5e9cc07a/aKRoUGXX6ygp4DlC/langsmith/images/custom-tool.gif?s=69638e515cd7c5be413cf13348e10974) Note: When running a custom tool in the playground, the model will respond with a JSON object containing the tool name and the tool call. Currently, there’s no way to connect this to a hosted tool via MCP. ![Tool call](https://mintcdn.com/langchain-5e9cc07a/ImHGLQW1HnQYwnJV/langsmith/images/tool-call.png?fit=max&auto=format&n=ImHGLQW1HnQYwnJV&q=85&s=44458ff5a2790122ffd7e8b62bf14032)
...
To understand the available tool choice options, check the documentation for your specific provider. For example, [OpenAI’s documentation on tool choice](https://platform.openai.com/docs/guides/function-calling/function-calling-behavior?api-mode=responses#tool-choice). ![Tool choice](https://mintcdn.com/langchain-5e9cc07a/ImHGLQW1HnQYwnJV/langsmith/images/tool-choice.png?fit=max&auto=format&n=ImHGLQW1HnQYwnJV&q=85&s=8685dbafdab37ed9529f8dbeceab72e6)
