...
section: "langsmith"
last_modified: "2026-01-08T16:42:32.259Z"
---
...
`LLM-as-judge` is a commonly used evaluator for RAG because it’s an effective way to evaluate factual accuracy or consistency between texts. ![rag-types.png](https://mintcdn.com/langchain-5e9cc07a/Fr2lazPB4XVeEA7l/langsmith/images/rag-types.png?fit=max&auto=format&n=Fr2lazPB4XVeEA7l&q=85&s=1252b1369be04ddb4c480af277443ac2) When evaluating RAG applications, you can have evaluators that require reference outputs and those that don’t:
...
Are documents relevant to the question?

No

Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-document-relevance)
...
Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-answer-hallucination)
...
Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-answer-helpfulness)
...
Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-answer-vs-reference)
...
Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/pairwise-evaluation-rag)
...
Is the summary accurate relative to the source documents?

No

Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/summary-accurancy-evaluator)

Yes

Faithfulness

Is the summary grounded in the source documents (e.g., no hallucinations)?

No

Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/summary-hallucination-evaluator)

Yes

Helpfulness

Is summary helpful relative to user need?

No

Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/summary-helpfulness-evaluator)
