---
title: "Cloud"
url: "https://docs.langchain.com/langsmith/cloud"
section: "langsmith"
last_modified: "2025-12-16T22:07:24.034Z"
---
...
**LangSmith platform (UI, APIs, datastores)**
...
![Cloud deployment: LangChain hosts and manages all components including the UI, APIs, and your Agent Servers.](https://mintcdn.com/langchain-5e9cc07a/JOyLr_spVEW0t2KF/langsmith/images/langgraph-cloud-architecture.png?fit=max&auto=format&n=JOyLr_spVEW0t2KF&q=85&s=3f0316122425895270d0ecd47b12e139)
...
This section is only relevant for the cloud-managed LangSmith services available at [https://smith.langchain.com](https://smith.langchain.com) and [https://eu.smith.langchain.com](https://eu.smith.langchain.com).For information on the self-hosted LangSmith solution, please refer to the [self-hosted documentation](/langsmith/self-hosted).
...
[https://eu.smith.langchain.com](https://eu.smith.langchain.com)
...
[LangSmith deployment](/langsmith/deployments)
...
![Light mode overview](https://mintcdn.com/langchain-5e9cc07a/rqYqeBEA_2oeiw17/langsmith/images/cloud-arch-light.png?fit=max&auto=format&n=rqYqeBEA_2oeiw17&q=85&s=0790cbdf4fe131c74d1e60bb120834e3)![Dark mode overview](https://mintcdn.com/langchain-5e9cc07a/rqYqeBEA_2oeiw17/langsmith/images/cloud-arch-dark.png?fit=max&auto=format&n=rqYqeBEA_2oeiw17&q=85&s=767f3bc3dc73ffe1a806f54e0aaa428b)
...
[High throughput](#rate-limit-categories)
...
[Repository](#rate-limit-categories)
...
[Run ingest](#rate-limit-categories)
...
[Multipart ingest](#rate-limit-categories)
...
[Run query (API)](#rate-limit-categories)
...
[Run query (User)](#rate-limit-categories)
...
[Generation](#rate-limit-categories)
...
[Deletion](#rate-limit-categories)
...
[Run lookup](#rate-limit-categories)
...
[Examples](#rate-limit-categories)
...
[Default (API key)](#rate-limit-categories)
...
[Default (User)](#rate-limit-categories)
...
[Public download](#rate-limit-categories)
...
[Stats](#rate-limit-categories)

All other IPs (catch-all)
...
[Public (catch-all)](#rate-limit-categories)
