...
url: "https://docs.langchain.com/langsmith/agent-server-api/threads/get-thread-state-at-checkpoint"
section: "langsmith/agent-server-api/threads"
last_modified: "2026-01-13T21:36:22.525Z"
---
...
```
curl --request GET \
  --url https://api.example.com/threads/{thread_id}/state/{checkpoint_id}
```
