...
url: "https://docs.langchain.com/langsmith/agent-server-api/assistants/get-assistant-subgraphs-by-namespace"
section: "langsmith/agent-server-api/assistants"
last_modified: "2026-01-13T21:36:22.432Z"
---
...
```
curl --request GET \
  --url https://api.example.com/assistants/{assistant_id}/subgraphs/{namespace}
```
