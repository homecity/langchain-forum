...
last_modified: "2026-01-13T21:36:22.747Z"
---
...
```
curl --request POST \
  --url https://api.example.com/runs/batch \
...
](#body-items-assistant-id-one-of-0)
...
](#body-items-stream-mode-one-of-0)
