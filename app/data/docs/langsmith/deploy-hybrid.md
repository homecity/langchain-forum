...
url: "https://docs.langchain.com/langsmith/deploy-hybrid"
section: "langsmith"
last_modified: "2026-01-06T20:30:18.596Z"
---
**Important** The Hybrid deployment option requires an [Enterprise](https://langchain.com/pricing) plan.
...
2.  Create a listener from the LangSmith UI. The `Listener` data model is configured for the actual [“listener” application](/langsmith/data-plane#%E2%80%9Dlistener%E2%80%9D-application).
...
3.  A [Helm chart](https://github.com/langchain-ai/helm/tree/main/charts/langgraph-dataplane) is provided to install the necesssary components in your Kubernetes cluster.
    -   `langgraph-dataplane-listener`: This is a service that listens to LangChain’s [control plane](/langsmith/control-plane) for changes to your deployments and creates/updates downstream CRDs. This is the [“listener” application](/langsmith/data-plane#%E2%80%9Dlistener%E2%80%9D-application).
