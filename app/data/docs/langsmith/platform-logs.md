...
url: "https://docs.langchain.com/langsmith/platform-logs"
section: "langsmith"
last_modified: "2025-12-16T22:07:24.569Z"
---
...
In the trace view, use the **See Logs** button in the top right corner, next to the **Run in Studio** button. ![View server logs button](https://mintcdn.com/langchain-5e9cc07a/1RIJxfRpkszanJLL/langsmith/images/view-server-logs-button.png?fit=max&auto=format&n=1RIJxfRpkszanJLL&q=85&s=87e85d7f38169b5259ba9b335aa89d2f) Clicking this button will take you to the server logs view for the associated deployment in LangSmith.
...
When you navigate from the trace view, the **Filters** box will automatically pre-fill with the Trace ID from the trace you just viewed. This allows you to quickly filter the logs to see only those related to your specific trace execution. ![Lgp server logs filters](https://mintcdn.com/langchain-5e9cc07a/4kN8yiLrZX_amfFn/langsmith/images/lgp-server-logs-filters.png?fit=max&auto=format&n=4kN8yiLrZX_amfFn&q=85&s=cb6f3c15ca3c8d462ee10c5fd190c73e)
