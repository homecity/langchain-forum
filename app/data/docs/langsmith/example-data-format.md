...
url: "https://docs.langchain.com/langsmith/example-data-format"
section: "langsmith"
last_modified: "2025-12-16T22:07:24.311Z"
---
...
The last time this example was modified

**inputs**

object

A map of inputs for the example.
...
The dataset the example belongs to

**source\_run\_id**

UUID

If this example was created from a LangSmith [`Run`](/langsmith/run-data-format), the ID of said run

**metadata**

object

A map of additional, user or SDK defined information that can be stored on an example.
