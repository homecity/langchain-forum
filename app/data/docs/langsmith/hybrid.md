---
title: "Hybrid"
url: "https://docs.langchain.com/langsmith/hybrid"
section: "langsmith"
last_modified: "2026-01-08T16:42:32.242Z"
---
**Important** The hybrid option requires an [Enterprise](https://langchain.com/pricing) plan.
...
![Hybrid deployment: LangChain-hosted control plane (LangSmith UI/APIs) manages deployments. Your cloud runs a listener, Agent Server instances, and backing stores (Postgres/Redis) on Kubernetes.](https://mintcdn.com/langchain-5e9cc07a/JOyLr_spVEW0t2KF/langsmith/images/hybrid-with-deployment-light.png?fit=max&auto=format&n=JOyLr_spVEW0t2KF&q=85&s=86d548632d33be3644bad7213287ac78) ![Hybrid deployment: LangChain-hosted control plane (LangSmith UI/APIs) manages deployments. Your cloud runs a listener, Agent Server instances, and backing stores (Postgres/Redis) on Kubernetes.](https://mintcdn.com/langchain-5e9cc07a/JOyLr_spVEW0t2KF/langsmith/images/hybrid-with-deployment-dark.png?fit=max&auto=format&n=JOyLr_spVEW0t2KF&q=85&s=829f0ef40c315c493ef8e30857e9abf5)
...
In the hybrid option, one or more [“listener” applications](/langsmith/data-plane#%E2%80%9Dlistener%E2%80%9D-application) can run depending on how your LangSmith workspaces and Kubernetes clusters are organized.
