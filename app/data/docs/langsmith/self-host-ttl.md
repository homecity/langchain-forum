...
url: "https://docs.langchain.com/langsmith/self-host-ttl"
section: "langsmith"
last_modified: "2026-01-08T16:42:32.431Z"
---
...
-   _Enabled:_ Whether data retention is enabled or disabled. If enabled, via the UI you can your default organization and project TTL tiers to apply to traces (see [data retention guide](/langsmith/administration-overview#data-retention) for details).
