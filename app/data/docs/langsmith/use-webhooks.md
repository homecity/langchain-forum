---
title: "Use webhooks"
url: "https://docs.langchain.com/langsmith/use-webhooks"
section: "langsmith"
last_modified: "2026-01-05T21:53:44.591Z"
---
...
Hostname allowlist. Supports wildcards for subdomains (e.g., `*.mycompany.com`).

`require_https`

Reject `http://` URLs when `true`.

`allowed_ports`

Explicit port allowlist. Defaults to 443 (https) and 80 (http).
...
Maximum permitted URL length in characters.
