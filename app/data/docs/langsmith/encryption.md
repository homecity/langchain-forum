...
url: "https://docs.langchain.com/langsmith/encryption"
section: "langsmith"
...
Checkpoint blobs only

Single static key, automatic AES encryption

**Custom encryption**

Checkpoints, threads, runs, assistants, crons and stores

Per-tenant keys, KMS integration, selective field encryption
