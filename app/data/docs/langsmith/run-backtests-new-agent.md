...
url: "https://docs.langchain.com/langsmith/run-backtests-new-agent"
section: "langsmith"
last_modified: "2026-01-08T16:42:32.363Z"
---
...
Once this step is complete, you should see a new dataset in your LangSmith project called “Tweet Writing Task-backtesting TODAYS DATE”, with a single experiment like so: ![Baseline experiment](https://mintcdn.com/langchain-5e9cc07a/E8FdemkcQxROovD9/langsmith/images/baseline-experiment.png?fit=max&auto=format&n=E8FdemkcQxROovD9&q=85&s=73b60a75d6b33f2830f5ed68464c586b)
...
After running both experiments, you can view them in your dataset: ![Dataset page](https://mintcdn.com/langchain-5e9cc07a/aKRoUGXX6ygp4DlC/langsmith/images/dataset-page.png?fit=max&auto=format&n=aKRoUGXX6ygp4DlC&q=85&s=1c5d4f1cf212e2c38917319c7bbf7f99) The results reveal an interesting tradeoff between the two models:
...
This insight demonstrates the value of backtesting - it helped us identify potential issues before deployment. ![Tutorial comparison view](https://mintcdn.com/langchain-5e9cc07a/1RIJxfRpkszanJLL/langsmith/images/tutorial-comparison-view.png?fit=max&auto=format&n=1RIJxfRpkszanJLL&q=85&s=a8ab311399f3d0e69554a62f939fd475)
