...
url: "https://docs.langchain.com/langsmith/manage-organization-by-api"
section: "langsmith"
last_modified: "2026-01-02T04:23:49.283Z"
---
...
`List roles` under [RBAC](#rbac) should be used for retrieving role IDs of these operations. `List [organization|workspace] members` endpoints (below) response `"id"`s should be used as `identity_id` in these operations. Organization level:
