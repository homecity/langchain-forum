...
url: "https://docs.langchain.com/langsmith/self-host-organization-charts"
section: "langsmith"
last_modified: "2025-12-16T22:07:24.750Z"
---
This feature is available on Helm chart versions 0.9.5 and later.

LangSmith automatically generates and syncs organization usage charts for self-hosted installations. These charts are available under `Settings > Usage and billing > Usage graph`:
