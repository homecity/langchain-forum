...
url: "https://docs.langchain.com/api-reference/deployments-v2/redeploy-revision"
section: "api-reference/deployments-v2"
last_modified: "2026-01-08T04:05:34.731Z"
---
...
```
curl --request POST \
  --url https://api.example.com/v2/deployments/{deployment_id}/revisions/{revision_id}/redeploy
```
